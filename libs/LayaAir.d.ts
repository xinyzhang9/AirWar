declare module laya.ani.bone {
    /**
     * <p> <code>Skeleton</code> 用于播放经过工具处理后的骨骼动画。</p>
     */
    class Skeleton extends laya.display.Animation {
        _tp_:Templet;

        /**
         * 创建一个 <code>Skeleton</code> 实例。
...
declare module laya.ani.bone {
    /**
     * <p> <code>Templet</code> 用于解析骨骼动画。</p>
     */
    class Templet {
        /** 每帧动画的长度。 */
        ...
        /**
         * 创建一个 <code>Templet</code> 实例。
         * @param    data 模板的数据资源对象。
         * @param    tex 模板的图片资源对象。
         */
        constructor(data:any, tex:any);

        /**
         * 根据指定的动作帧索引，获取对应的显示对象。
         * @param    i 动作对应的动画的帧索引（例如:walk动作的第几帧）。
         * @param    _index_ 动作的索引。
         * @return 一个 Graphics 对象。
         */
...
declare module laya.webgl.submit {
    ...
    class Submit implements laya.webgl.submit.ISubmit {
        ...
        protected _selfVb:laya.webgl.utils.Buffer;
        protected _ib:laya.webgl.utils.Buffer;
...
declare module laya.webgl.submit {
    ...
    class SubmitOtherIBVB implements laya.webgl.submit.ISubmit {
        ...
        protected _vb:laya.webgl.utils.Buffer;
        protected _ib:laya.webgl.utils.Buffer;
        protected _blendFn:Function;
...
declare module laya.webgl.utils {
    ...
    class Buffer extends laya.resource.Resource {
        ...
        protected static _bindActive:Array<any>;
...
declare module Laya {
    ...
    //class ColorFilter extends laya.webgl.shader.d2.filters.ColorFilter{}
    class GlowFilterShader extends laya.webgl.shader.d2.filters.GlowFilterShader {
    }
